...
public class SuperAdminClient extends JFrame{
	...
	private DefaultMutableTreeNode dmtn2=
	        new DefaultMutableTreeNode(new MyNode("楼栋管理信息维护","2"));
	private DefaultMutableTreeNode dmtn3=
			new DefaultMutableTreeNode(new MyNode("系别信息维护","3"));
	private DefaultMutableTreeNode dmtn4=
			new DefaultMutableTreeNode(new MyNode("数据的还原|恢复","4"));
	...
	private DefaultMutableTreeNode dmtn21=
	        new DefaultMutableTreeNode(new MyNode("楼栋信息维护","21"));
	...
	private DefaultMutableTreeNode dmtn23=
	        new DefaultMutableTreeNode(new MyNode("学生信息维护","23"));
	...
	private DefaultMutableTreeNode dmtn31=
			new DefaultMutableTreeNode(new MyNode("系别信息维护","31"));
	private DefaultMutableTreeNode dmtn32=
			new DefaultMutableTreeNode(new MyNode("专业信息维护","32"));
	private DefaultMutableTreeNode dmtn33=
			new DefaultMutableTreeNode(new MyNode("班级信息维护","33"));
	//创建跟节点
